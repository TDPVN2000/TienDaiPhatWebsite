...
import { deleteCateStoreApi, updateCateStoreApi } from "api/masterData";
import ModalDeleteItem from "components/ModalDeleteItem";
import { ActionModal } from "constants/enums";

const DraggableCateStore = (props: any) => {
...
export default DraggableCateStore;
